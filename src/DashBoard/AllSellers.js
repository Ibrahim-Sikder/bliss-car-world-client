...
const AllSellers = () => {
    ...
    const handleDeleteSeller = seller => {
        fetch(`https://bliss-car-world-server-ibrahim-sikder.vercel.app/users/${seller?._id}`, {
            method: 'DELETE',
            headers: {
    ...
    const handleMakeAdmin = id => {
        fetch(`https://bliss-car-world-server-ibrahim-sikder.vercel.app/users/users/admin/${id}`, {
            method: 'PUT',
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
