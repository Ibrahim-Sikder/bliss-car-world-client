...
const AdvertizeSection = () => {
    return (
        <div className='bg-[#0E0F20] text-white'>
            ...
            <div className='lg:flex p-5 m-5 mt-10 shadow-lg rounded-lg'>
                <div className='flex items-center p-5 lg:w-1/2'>
                    ...
                    <div>
                        ...
                        <button className='btn btn-xs btn-outline mt-4 border-white bg-[#0E0F20] text-white'>Add Your Phone</button>
                    </div>
                </div>
                ...
                <div className='flex items-center p-5 lg:w-1/2'>
                    ...
                    <div>
                        ...
                        <button className='btn btn-xs btn-outline mt-4 border-white bg-[#0E0F20] text-white'>Add Your Tablet</button>
                    </div>
                </div>
            </div>

            <div className='flex justify-center p-5 bg-[#343657] mt-10 m-5 shadow-2xl rounded-lg'>
            ...
            <div className='lg:flex items-center p-5 '>
                    ...
                    <div>
                        ...
                        <button className='btn text-white border-white btn-xs btn-outline mt-4'><Link to="/usedMobiles">Visit Our Shop</Link></button>
                    </div>
                </div>
            </div>
        </div>
