...
const UsedMobiles = () => {
    ...
    const {data: usedMobiles = [], isLoading} = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://bliss-car-world-server-ibrahim-sikder.vercel.app/allItems`);
    ...
    // useEffect(() => {
    //     fetch(`https://bliss-car-world-server-ibrahim-sikder.vercel.app/allItems`)
    //         .then(res => res.json())
