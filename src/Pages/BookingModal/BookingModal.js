...
const BookingModal = ({ treatment, setTreatment }) => {
  ...
  const handleBooking = (event) => {
    ...
    fetch(`https://bliss-car-world-server-ibrahim-sikder.vercel.app/bookings`, {
      method: "POST",
      headers: {
        ...
        <div className="modal-box relative">
          ...
          <form onSubmit={handleBooking}>
            ...
            <input
              name="originalPrice"
              type="text"
              value={`Original Price : ${originalPrice} Taka`}
              className="input input-bordered input-secondary w-full mt-3 "
              disabled
            />
            <input
              name="resalePrice"
              type="text"
              value={`Resale Price : ${resalePrice} Taka`}
              className="input input-bordered input-secondary w-full mt-3 "
              disabled
            />
            <input
              name="publishDate"
              type="text"
              value={`Publish Date : ${publishDate}`}
              className="input input-bordered input-secondary w-full mt-3 "
              disabled
            />
            <input
              name="yearsOfUsed"
              type="text"
              value={`Years of Used : ${yearsOfUsed}`}
              className="input input-bordered input-secondary w-full mt-3 "
              disabled
            />
            <input
